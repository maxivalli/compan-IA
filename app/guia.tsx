...
const SECCIONES: Seccion[] = [
  ...
  },
  {
    ...
    nota: 'Géneros: tango, bolero, folklore, romántica, clásica, jazz, pop. Radios: Mitre, Continental, Rivadavia, Cadena 3, La Red, Metro, Rock & Pop y más. Con música sonando podés hablarle a Rosita mencionando su nombre — baja el volumen, responde y vuelve a subir.',
  },
  {
