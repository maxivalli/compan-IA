...
const SECCIONES: Seccion[] = [
  ...
  },
  {
    ...
    titulo: 'Música',
    descripcion: 'Pedí música por género o por nombre de radio y Rosita la pone al instante. Para pararla, tocá cualquier parte de la pantalla.',
    color: '#6A0D91',
    bg: '#F0DEFF',
    comandos: ['Poné tango', 'Quiero folklore', 'Poneme jazz', 'Poné Radio Mitre', 'Quiero Radio Nacional'],
    nota: 'Géneros: tango, bolero, folklore, romántica, clásica, jazz, pop. Radios: Mitre, Continental, Rivadavia, Nacional, Cadena 3, La Red, Metro. Mientras suena música el micrófono se apaga solo — tocá la pantalla para parar.',
  },
  {
